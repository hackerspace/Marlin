...
// Bistro I3 w/E3D extruder
    #define  DEFAULT_Kp 41.37
    #define  DEFAULT_Ki 5.22
    #define  DEFAULT_Kd 82.01
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -38.60
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 4.70
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -6.50
  ...
  #define PROBE_SERVO_DEACTIVATION_DELAY 666
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,582}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 3.125, 25}    // (mm/sec)
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 10,120} // X,Y,Z Axis Extend and Retract angles
