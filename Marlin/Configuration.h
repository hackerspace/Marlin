...
#define DELTA_DIAGONAL_ROD 249.1 // mm
...
#define HOMING_FEEDRATE {90*60, 90*60, 90*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,160,97.4 * 2}  // default steps per unit for Ultimaker
